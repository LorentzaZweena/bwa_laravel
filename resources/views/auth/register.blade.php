<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <select name="account_type" class="w-full border border-slate-300 rounded-lg mt-2">
        ...
        <!-- Experience -->
         <div class="mt-4">
            ...
            <x-text-input id="experience" class="block mt-1 w-full" type="number" name="experience" :value="old('experience')" required autocomplete="experience" />
