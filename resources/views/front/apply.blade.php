...
<body class="font-poppins text-[#0E0140] pb-[100px] overflow-x-hidden">
    ...
    <form action="success.html" class="relative max-w-[900px] mx-auto flex flex-col rounded-[20px] bg-white border border-[#E8E4F8] p-[30px] gap-10 shadow-[0_8px_30px_0_#0E01400D] mt-[130px]">
        ...
        <div id="Cover-Letter-Container" class="flex flex-col gap-4">
            ...
            <div class="flex rounded-[20px] bg-white ring-1 ring-[#0E0140] p-[14px_24px] gap-[10px] focus-within:ring-2 focus-within:ring-[#FF6B2C] transition-all duration-300">
                ...
                <textarea name="coverLetter" id="coverLetter" rows="9" class="appearance-none outline-none w-full font-semibold placeholder:text-[#0E0140]" placeholder="Tell your great skills and experiences" required></textarea>
            </div>
        </div>
